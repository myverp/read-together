...
- DRM-free EPUBs, up to 25 MB. No PDF. EPUB scripts remain disabled in sandboxed iframes. Heavy illustrated/fixed-layout books can behave differently or exceed a phone's memory.
